...
def usage():
    ...
    print("|    /~~\ \__/ / \    | \| |___  |  \__, /~~\  |  ")
    print("\nFaux Netcat v. 0.1\n")
    print("Usage: faux-netcat-py2.py -t target_host -p port\n")
    ...
    print("Examples:\n")
    print("faux-netcat-py2.py -t 192.168.0.1 -p 1337 -l -c")
    print("faux-netcat-py2.py -t 192.168.0.1 -p 1337 -l -u=C:\\target.exe")
    print("faux-netcat-py2.py -t 192.168.0.1 -p 1337 -l -e=\"cat /etc/passwd\"")
    print("echo 'ABCDEFG' | ./faux-netcat-py2.py -t 192.168.0.1 -p 1337")
    sys.exit(0)
